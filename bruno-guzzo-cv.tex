...
%		\vspace{4pt}
		...
		\begin{itemize}[leftmargin=*, nosep, itemsep=2pt]
			...
			\item \textbf{Infra}: VPC, Load Balancer, IAM, Cloud Armor
		\end{itemize}
		\vspace{4pt}
		...
		\begin{itemize}[leftmargin=*, nosep, itemsep=2pt]
			...
			\item \textbf{Architecture}: GNNs (Graph Neural Networks), CNN (Convolutional Neural Networks), Autoencoder, Transformer, Self-Attention Mechanisms, Graph Attention Networks (GAT), GPT, BERT, Vision Transformers (ViTs), VGGNet, AlexNet
			
			\item \textbf{Concepts}: LLM (Large Language Models), RAG (Retrieval-Augmented Generation), NLP (Natural Language Processing), Deep Learning, Fine-Tuning (QLoRA), Vector Databases, Embeddings, Anomaly Detection, Time-Series Analysis, Link Prediction, Semi-Supervised Learning, Class Imbalance, Under-sampling Techniques, Hyperparameter Tuning, Model Evaluation, Reinforcement Learning  
		\end{itemize}
		\vspace{4pt}
		...
		\begin{itemize}[leftmargin=*, nosep, itemsep=2pt]
			...
			\item \textbf{Frameworks}: Spring Boot, Hibernate, JPA, Flask, Django, SQLAlchelmy Angular, React, Flutter
