...
\begin{document}
	...
	\begin{center}
		...
		\vspace{4pt}
		{\Large \textbf{System Engineer} | AI \& ML Specialist}
	\end{center}
%	\vspace{5pt}
	...
	\begin{minipage}[t]{0.65\linewidth}
		...
		\jobsection{\textbf{System Engineer}}{April 2026 -- Present}{\href{https://aws.amazon.com/}{AWS (EUSC, Managed Operations), Dublin}}
		\begin{itemize}[leftmargin=*, nosep]
			\item \footnotesize Providing system engineering and operational support within the \textbf{European Union Sovereignty Cloud (EUSC)} Managed Operations, ensuring high availability and compliance for critical infrastructure. Responsible for managing and scaling \textbf{Amazon DynamoDB} and \textbf{Amazon Redshift} clusters.
		\end{itemize}
		
		\vspace{7pt}
		\jobsection{\textbf{AI Specialist} (Mid-Senior Consultant)}{January 2025 -- April 2026}{\href{https://www.reply.com/go-reply/en}{Go Reply, Turin}}
	...
	\begin{minipage}[t]{0.32\linewidth}
		...
		\begin{tabularx}{\linewidth}{@{}lX@{}}
			...
			\faLink & \href{https://huggingface.co/bguzzo2k}{huggingface.co/bguzzo2k} \\
		\end{tabularx}
		\vspace{10pt}
		...
		{\bfseries Amazon Web Services}
		\begin{itemize}[leftmargin=*, nosep, itemsep=2pt]
			\footnotesize
			\item \textbf{Services}: Lambda, DynamoDB, Redshift, S3, IAM, VPC
			\item \textbf{Tools}: CDK, CloudFormation, AWS CLI
		\end{itemize}
		\vspace{6pt}
		
		{\bfseries Google Cloud}
		\begin{itemize}[leftmargin=*, nosep, itemsep=2pt]
			\footnotesize
			\item \textbf{Compute/AI}: Cloud Run, Functions, Vertex AI, Gemini, BigQuery ML
			\item \textbf{Data/Infra}: BigQuery, SQL, VPC, IAM, Pub/Sub, Cloud Task, Firestore
		\end{itemize}
		\vspace{6pt}
		...
		\begin{itemize}[leftmargin=*, nosep, itemsep=2pt]
			\footnotesize
			\item \textbf{Tools}: PyTorch, Langchain, Hugging Face, NumPy, Scikit-learn
			\item \textbf{Concepts}: LLM, RAG, NLP, Fine-Tuning, GNNs, Anomaly Detection
		\end{itemize}
		\vspace{6pt}
		...
		\begin{itemize}[leftmargin=*, nosep, itemsep=2pt]
			...
			\item \textbf{Others}: Linux, Git, Bash scripting, NginX
		\end{itemize}
		\vspace{6pt}
