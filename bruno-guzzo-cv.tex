...
%		\begin{itemize}[leftmargin=*, nosep]
%			\item \footnotesize Enhanced the ``LLaMAntino-3'' model by fine-tuning it on the Italian Wikipedia, resulting in significantly improved language modeling capabilities, as evidenced by reduced perplexity. Developed a RAG-based chatbot using the fine-tuned model to answer questions about Italian literature, leveraging a custom corpus of documents.
%		\end{itemize}
